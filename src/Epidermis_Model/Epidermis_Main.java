...
class EpidermisConst{
    ...
    static final double FIXProb = 1.0; // Probability of Fixation for induced mutation
}
...
//        Utils.PrintMemoryUsage();
        ...
        /*
         Format: Replicate , FixationTime , CellAge , TissueHeight , MeanRLambda
         If FixedTime == nan then the mutation was lost due to drift
        */
        System.out.println(Rep + "\t" + EpidermisConst.FIXProb + "\t" + FixedTime + "\t" + "NaN" + "\t" + Epidermis.GetMeanCellHeight() + "\t" + (r_lambOut / r_lambda_index));
    }
}
